...
if(isset($_POST['submit'])){
	...
	$sql = "UPDATE `information` SET `sitename`=:title , `email` = :email, `tel` = :tel, `mobile` = :mobile,`address` = :address, `instagram` = :instagram,`whatsapp`=:whatsapp,`telegram`=:telegram ";
            ...
            <form action="" method="post">
                <div class="form-group row">
                    <div class="col-4">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="عنوان سایت" value="<?=$rows['sitename']?>">
                    </div>
                    <div class="col-4">
                        <label>تلفن:</label>
