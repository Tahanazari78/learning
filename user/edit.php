...
if(isset($_POST['btn_save'])){
    ...
    $q = $conn->prepare("UPDATE `users` SET `name`=?,`family`=?,`tel`=?,`email`=?,`pic`=?,`age`=? WHERE `ID`=?");
    $q->bindParam(1,$name);
    ...
    <div class="container">
        ...
        <div class="row pb-5">
            ...
            <div class="col-md-8">
                <div class="card shadow text-right">
                    <div class="card-body">
                        <span class="font-weight-bold">ویرایش اطلاعات</span>
                        <hr>
                        <?=$message?>
                        <form class="form-group" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="mobile" minlength="11" maxlength="11" value="<?=$rows['tel']?>">
                                </div>
                                ...
                                <div class="form-group col-md-2">
                                    <label>سن</label>
                                    <input type="text" name="age" class="form-control" value="<?=$rows['age']?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col">
                                ...
                                <?php if($rows['pic']!=''){ ?>
                                    <div class="form-group col">
                                        <img src="../img/avatar/<?=$rows['pic']?>" class="w-50 img-thumbnail float-left">
                                    </div>
                                <?php } ?>
                            </div>
